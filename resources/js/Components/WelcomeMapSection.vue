...
const filteredMapProjects = computed(() =>
    props.mapProjects.filter((project) => {
        ...
        return region === props.activeCountry;
    })
);
...
const bindMapListeners = () => {
    ...
    Object.keys(mapProjectsByLand.value).forEach((landId) => {
...
<template>            <section class="mx-auto max-w-6xl px-4 pb-28 sm:px-6 lg:px-8">
                <div class="mb-[100px]">
